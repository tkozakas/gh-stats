        ...
        <form onSubmit={handleSearch} className="mt-12">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-neutral-800 bg-neutral-900/80 py-4 pl-14 pr-32 text-lg text-white placeholder-neutral-500 backdrop-blur-sm transition-all focus:border-neutral-700 focus:outline-none"
            />
            <button
              type="submit"
              disabled={searching || !query.trim()}
              className="absolute right-2 top-1/2 -translate-y-1/2 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-2.5 font-medium text-white transition-all hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {searching ? (
